...
var LayerMgr = (function () {
    function LayerMgr() {
        ...
        this._effectLayer = null; // 特效层
        this._noticeLayer = null; // 消息层(跑马灯)
        this.init();
    }
    // 初始化管理器
    LayerMgr.prototype.init = function () {
        ...
        this._stage.addChild(this._noticeLayer);
    ...
    Object.defineProperty(LayerMgr.prototype, "effectLayer", {
        /*获取场景特效层*/
        get: function () {
